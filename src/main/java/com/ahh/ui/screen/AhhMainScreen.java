package com.ahh.ui.screen;

import com.ahh.AhhClientEvents;
...
public class AhhMainScreen extends Screen {
    ...
    public AhhMainScreen(Screen parent) {
        super(Text.literal("Ahh Client"));
        this.modules = AhhClientEvents.moduleManager.getModules();
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Draw title
        context.drawCenteredTextWithShadow(this.textRenderer, "Ahh Client", 
